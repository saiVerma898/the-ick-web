      ...
      <div className="mx-auto flex w-full max-w-md flex-col gap-10 px-5 pb-16 pt-8 sm:max-w-2xl sm:px-8 lg:max-w-5xl">
        ...
        <section className="space-y-6">
          <div className="text-center">
            ...
            <h2 className="mt-2 text-3xl font-semibold">#1 Follow Tracker App</h2>
          </div>
          ...
          <button className="w-full rounded-3xl bg-pink-300 py-4 text-lg font-semibold text-white shadow-sm">
            Continue
          </button>
        </section>
